...
const en: Translations = {
  ...
  modal: {
    ...
    titleWithFile: 'Add {name} to the map',
    ...
    sectionManual: 'Manual star identification',
    ...
    errorDetailsSummary: 'Technical details (for bug report)',
    errorDetailsCode: 'Error code',
    errorDetailsStatus: 'HTTP status',
    errorDetailsBody: 'Response body',
