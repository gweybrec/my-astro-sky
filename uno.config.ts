...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'tag-chip-sm': 'inline-flex items-center gap-1 px-3 py-px rounded-xl text-micro border border-[var(--accent-fill-lg)] bg-transparent text-label',

    // ── Status banners ────────────────────────────────────────────────────────
    'status-success': 'bg-[var(--status-success-bg)] border border-[var(--status-success-border)] text-[var(--status-success-text)]',
    'status-error':   'bg-[var(--status-error-bg)] border border-[var(--status-error-border)] text-[var(--status-error-text)]',
