...
const CORRECTED_SH2_280_289 = [
  ...
  ['SH2-280', 92.25, 20.30, 30, null],  // Was: 86.84, 1.97 ❌
  
  // SH2-281 in Monoceros 
  ['SH2-281', 93.45, 4.40, 5, null],    // Was: 88.89, 7.40 ❌
  
  // SH2-283 in Monoceros
  ['SH2-283', 94.70, 0.20, 5, null],    // Was: 89.75, 9.57 ❌
  
  // SH2-284 in Monoceros
  ['SH2-284', 100.50, -3.77, 30, null], // Was: 96.55, 21.26 ❌
  
  // SH2-285 in Monoceros
  ['SH2-285', 101.85, -3.50, 10, null], // Was: 101.85, 29.55 ❌ (RA OK, Dec wrong)
  
  // SH2-286 in Monoceros  
  ['SH2-286', 111.18, 1.30, 8, null],   // Was: 111.18, 7.18 ❌ (RA OK, Dec wrong)
  
  // SH2-289 in Monoceros
  ['SH2-289', 112.09, 1.60, 5, null],   // Was: 112.09, 13.14 ❌ (RA OK, Dec wrong)
];
