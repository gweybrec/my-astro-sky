<div class="home-hero">
  <img src="icon.png" alt="MyAstroSky icon">
  <h1>MyAstroSky</h1>
  <p>An interactive sky map to overlay and plan your astrophotography</p>
</div>

<div class="cta-grid">
  <a href="#/user/getting-started" class="cta-card">
    <span class="cta-icon">📖</span>
    <span class="cta-title">User Guide</span>
    <span class="cta-desc">Get started, upload photos, plate solve, plan targets</span>
  </a>
  <a href="#/dev/architecture" class="cta-card">
    <span class="cta-icon">⚙</span>
    <span class="cta-title">Developer Docs</span>
    <span class="cta-desc">Architecture, UI guidelines, DSO catalog, CI/CD</span>
  </a>
</div>
