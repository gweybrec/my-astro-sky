...
const en: Translations = {
  ...
  display: {
    ...
    maxStarCount: 'Max star count',
    maxDSOCount: 'Max DSO count',
  ...
  settings: {
    ...
    maxStarCount: 'Max star count',
    maxDSOCount: 'Max DSO count',
    starSliderMax: 'Star slider max',
    dsoSliderMax: 'DSO slider max',
    showStarTooltips: 'Show star tooltips',
    showDSOTooltips: 'Show DSO tooltips',
  ...
  fovOverlay: {
    ...
    resetFrameRotation: 'Reset frame rotation',
    expandRibbon: 'Show rotation controls',
    collapseRibbon: 'Hide rotation controls',
    selectAll: 'Select all',
    ...
    rotateNeedsSelection: 'Select a frame on the map to rotate it.',
