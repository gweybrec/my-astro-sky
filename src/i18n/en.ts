...
const en: Translations = {
  ...
  settings: {
    ...
    exportFull: 'Export metadata + images (ZIP)',
    exportMetadata: 'Export metadata only (JSON)',
    exportOptions: 'Export content',
    exportImages: 'Export images',
    exportPhotoMeta: 'Export photo metadata',
    exportDsoOverrides: 'Export DSO metadata overrides',
    exportCustomGear: 'Export custom telescopes/cameras/accessories',
    exportSetups: 'Export setups',
    exportBtn: 'Export',
    importedDsoOverrides: '{n} DSO override(s) imported',
    exportSelectTitle: 'Select photos to export',
    ...
    importBackupWarning: 'Recommended: export a backup of your current data before importing.',
    deleteBackupWarning: 'Recommended: export a backup of your current data before deleting anything.',
    importBackupBtn: 'Export backup (ZIP)',
    importSuccess: 'Imported: {n} photo(s) ({s} skipped)',
    ...
    aboutFeatures: 'Stereographic polar projection · Plate solving (ASTAP, solve-field, astrometry.net) · 12,000+ deep-sky objects · Target recommendations · Import / export to transfer between devices and users',
