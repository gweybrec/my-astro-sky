...
function makeDso(dec: number): DSO {
  return { id: 'X', ra: 0, dec, mag: 8, majAxis: 10, minAxis: 10, pa: 0, type: 'Gx' } as unknown as DSO;
}
...
describe('angularSizeToCanvasPx', () => {
  ...
  it('uses a supplied cos2 verbatim (matches the internal formula)', () => {
    ...
    expect(angularSizeToCanvasPx(60, 30, 1000, cos2)).toBeCloseTo(angularSizeToCanvasPx(60, 30, 1000), 6);
  });
