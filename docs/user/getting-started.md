...
A desktop installer and portable zips are available on the [GitHub Releases](https://github.com/gweybrec/my-astro-sky/releases) page — download the installer for your platform and double-click to install, no terminal required.
...
3. Choose a plate-solving method:
   ...
   - **ASTAP (local)** — fastest (3–5 sec) but requires [installation](installing-solvers.md). Works on Windows, macOS, Linux.
...
- [Features Reference](user-guide.md) — complete guide to every feature
- [Installing Plate Solvers](installing-solvers.md) — set up ASTAP or solve-field for offline solving
